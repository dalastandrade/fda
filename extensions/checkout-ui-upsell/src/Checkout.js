...
function updateProductComponents(
  ...
  //   console.log('product.attributes[i].key ', product.attributes[i].key)
  //   if (product.attributes[i].key == "_full_price") {
  //     containsFullPrice = true;
  //     product.attributes.push({key:"_discount", value: "15.0"})
  //   }
  // }
  console.log('containsFullPrice ', containsFullPrice)
  ...
  if (containsFullPrice) {
    merchandise.sellingPlan = 'gid://shopify/SellingPlan/885522530';
  } else {
...
function updateProductComponentsTwo(
  ...
  if (containsFullPrice) {
    merchandiseTwo.sellingPlan = 'gid://shopify/SellingPlan/885522530';
  } else {
